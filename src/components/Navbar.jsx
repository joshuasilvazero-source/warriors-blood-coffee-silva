            ...
            <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-8">
                    <nav className="flex items-center space-x-8 uppercase text-xs tracking-widest font-semibold">
                        ...
                        <Link className="hover:text-brandGold transition-colors" to="/products">
                            Products
                        </Link>

                        <Link className="hover:text-brandGold transition-colors" to="/about">
                            About Us
                        </Link>

                        <Link className="hover:text-brandGold transition-colors" to="/contact">
                            Contact Us
                        </Link>
                    </nav>
