                    ...
                    <div className="flex-1 overflow-y-auto p-7 md:p-9">
                        ...
                        <div className="space-y-3 mb-7">
                            {product.description.map((para, i) => (
                                <p
                                    key={i}
                                    className="text-gray-300 text-sm leading-relaxed font-serif">
                                    {para}
                                </p>
                            ))}
                        </div>
                        ...
                        <div className="flex items-start gap-4 bg-brandGold/5 border border-brandGold/20 rounded-2xl p-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400 leading-relaxed">
                                    Every bag is roasted in small batches to ensure quality, flavor,
                                    and consistency — from our roaster to your cup.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="relative z-10 max-w-7xl mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 font-serif italic max-w-xl mx-auto">
                        Each roast is crafted with precision, sourced with integrity, and roasted to
